...
from utils_lsun import SDE,ema
import copy
...
# Load the model
PATH = f"{FLAGS.input_dir}/{FLAGS.model+'-'+str(FLAGS.flow_w)+'-'+ str(FLAGS.sigma)}/{FLAGS.model}_lsun_bed_weights_step_final.pt"
print("path: ", PATH)
...
save_dir=f'./result/lsun_bed/images_ema_{SDE_sigma:.1f}/'
